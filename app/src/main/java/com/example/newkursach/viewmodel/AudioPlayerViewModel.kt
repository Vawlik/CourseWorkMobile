...
class AudioPlayerViewModel(private val dao: AudioRecordDao) : ViewModel() {
    ...
    companion object {
        fun Factory(): ViewModelProvider.Factory = object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(
                ...
                return AudioPlayerViewModel(AppDatabase.getInstance(application).audioRecordDao()) as T
            }
        }
    }
}